...
const Navbar = ({ onSelectCategory, onSearch }) => {
  ...
  const handleChange = async (value) => {
    ...
    try {
      const response = await axios.get(
        `https://shoppee-backend.up.railway.app/api/products/search?keyword=${value}`
      );
      setSearchResults(response.data);
  ...
  //         response = await axios.get(`https://shoppee-backend.up.railway.app/api/products/search?id=${value}`);
  //       } else {
  //         // Input is not a number, search by keyword
  //         response = await axios.get(`https://shoppee-backend.up.railway.app/api/products/search?keyword=${value}`);
  //       }
